...
function SidebarContent({ onLogout }: Pick<SidebarProps, 'onLogout'>) {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center gap-2 shadow-lg border-0 px-6">
        <img src="/logo.png" alt="PetroGoals Logo" className="w-5" />
      ...
      <div className="border-0 p-3 space-y-3">
...
export function Sidebar({ onLogout }: Pick<SidebarProps, 'onLogout'>) {
  ...
  if (isMobile) {
    return (
      <>
        <div className="fixed top-0 left-0 right-0 z-40 flex h-16 items-center justify-between gap-4 border-0 bg-background px-4">
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-0 shadow-lg bg-sidebar">
